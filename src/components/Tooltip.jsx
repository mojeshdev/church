  ...
  return (
    <StyledWrapper>
      <ul className="example-2">
        ...
        <li className="icon-content">
          <a data-social="facebook" aria-label="Facebook" href="https://www.facebook.com/share/17YPZDUw78/">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a data-social="instagram" aria-label="Instagram" href="https://www.instagram.com/prasangi_vadlamudi?igsh=a2UxMTNucDV1azA0">
            <div className="filled" />
