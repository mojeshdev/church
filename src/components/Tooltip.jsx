    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a data-social="whatsapp" aria-label="Whatsapp" href="https://api.whatsapp.com/send?phone=+919052623886&text=Save%20this%20to%20your%20Favorites%20-%20@wilsondesouza">
        ...
        <li className="icon-content">
          <a data-social="facebook" aria-label="Facebook" href="https://www.facebook.com/share/1FBEdpGfo3/">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a data-social="instagram" aria-label="Instagram" href="https://www.instagram.com/prasangi_vadlamudi/?utm_source=ig_web_button_share_sheet">
            <div className="filled" />
